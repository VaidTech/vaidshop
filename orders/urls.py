...
from .views import (order_confirm_view, order_list_view, order_delete_view,
	order_product_view,order_confirm_update_view, order_product_update_view, order_detail_view)
...
urlpatterns = [
	...
	path('detail/<int:id>/', order_detail_view, name="detail"),
